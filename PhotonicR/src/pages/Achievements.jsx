    ...
    icon: (
      <span className="text-4xl text-green-400">
        ...
        <svg width="40" height="40" fill="none" viewBox="0 0 24 24">
          <path d="M12 3l7 4v5c0 5-3.5 9-7 9s-7-4-7-9V7l7-4z" stroke="#39FF14" strokeWidth="2" fill="none"/>
        </svg>
      </span>
    ),
    desc: (
  ...
  },
  {
    ...
    icon: (
      <span className="text-4xl text-green-400">
        {/* Rupee icon */}
        <svg width="40" height="40" fill="none" viewBox="0 0 24 24">
          <path d="M6 4h12M6 8h12M9 4v12a4 4 0 004 4h3" stroke="#39FF14" strokeWidth="2" strokeLinecap="round"/>
        </svg>
      </span>
    ),
    desc: (
  ...
  },
  {
    ...
    icon: (
      <span className="text-4xl text-green-400">
        {/* Academic cap icon */}
        <svg width="40" height="40" fill="none" viewBox="0 0 24 24">
          <path d="M12 3L2 9l10 6 10-6-10-6zm0 13v5m-7-7v2a7 7 0 0014 0v-2" stroke="#39FF14" strokeWidth="2" strokeLinejoin="round"/>
        </svg>
      </span>
    ),
    desc: (
...
const Achievements = () => {
  return (
    <section className="min-h-[60vh] bg-gray-100 flex flex-col items-center justify-center py-16 px-4">
      <h2 className="text-3xl md:text-4xl font-extrabold text-[#0D1B2A] mb-10 text-center">
        Recognized for Innovation
      </h2>
      <p className="max-w-2xl text-gray-600 text-center mb-12">
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-5xl justify-center items-stretch">
        {achievements.map((ach, idx) => (
          <div
            key={ach.title}
            className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 flex-1 min-w-[260px] max-w-sm p-8 flex flex-col items-center text-center"
          >
            <div className="mb-4">{ach.icon}</div>
            <h3 className="text-xl font-bold text-[#0D1B2A] mb-2">{ach.title}</h3>
            <p className="text-gray-600">{ach.desc}</p>
            <div className="mt-6 w-full border-t border-gray-200 pt-4 text-xs text-gray-400">
              <span>
      ...
      {/* Section Footer */}
      <div className="mt-14 max-w-3xl text-center text-gray-500 text-base">
        <span>
